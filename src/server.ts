...
async function main(): Promise<void> {
  ...
  //   {user: 6, game: gdb.fromWeekTeam(2, 'JAC').data.id, team: tdb.fromAbbr('KC').data.id},
  //   {user: 6, game: gdb.fromWeekTeam(2, 'NE').data.id, team: tdb.fromAbbr('MIA').data.id},
  //   {user: 6, game: gdb.fromWeekTeam(3, 'WAS').data.id, team: tdb.fromAbbr('BUF').data.id},
  ...
  //   {user: 6, game: gdb.fromWeekTeam(7, 'NO').data.id, team: tdb.fromAbbr('JAC').data.id},
  ...
  //   {user: 5, game: gdb.fromWeekTeam(5, 'WAS').data.id, team: tdb.fromAbbr('WAS').data.id},
  ...
  //   {user: 4, game: gdb.fromWeekTeam(4, 'JAC').data.id, team: tdb.fromAbbr('ATL').data.id},
  //   {user: 4, game: gdb.fromWeekTeam(4, 'TEN').data.id, team: tdb.fromAbbr('CIN').data.id},
  //   {user: 4, game: gdb.fromWeekTeam(5, 'WAS').data.id, team: tdb.fromAbbr('WAS').data.id},
  //   {user: 4, game: gdb.fromWeekTeam(5, 'BUF').data.id, team: tdb.fromAbbr('JAC').data.id},
  ...
  //   {user: 4, game: gdb.fromWeekTeam(7, 'NO').data.id, team: tdb.fromAbbr('JAC').data.id},
  ...
  //   {user: 2, game: gdb.fromWeekTeam(2, 'JAC').data.id, team: tdb.fromAbbr('JAC').data.id},
  //   {user: 2, game: gdb.fromWeekTeam(2, 'JAC').data.id, team: tdb.fromAbbr('OVR').data.id},
  ...
  //   {user: 2, game: gdb.fromWeekTeam(5, 'WAS').data.id, team: tdb.fromAbbr('CHI').data.id},
  ...
  //   {user: 2, game: gdb.fromWeekTeam(7, 'NO').data.id, team: tdb.fromAbbr('JAC').data.id},
  ...
  //   {user: 1, game: gdb.fromWeekTeam(7, 'NYG').data.id, team: tdb.fromAbbr('WAS').data.id},
  ...
  //   {user: 0, game: gdb.fromWeekTeam(3, 'WAS').data.id, team: tdb.fromAbbr('BUF').data.id},
