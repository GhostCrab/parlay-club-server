...
class TeamDB {
  ...
  private static teams: ITeam[] = [
    ...
    new Team({ id: 13,    city: "LAS VEGAS",     name: "RAIDERS",    abbr: "LV",  iconURL: "https://ssl.gstatic.com/onebox/media/sports/logos/QysqoqJQsTbiJl8sPL12Yg_48x48.png", active: true}),
    ...
    new Team({ id: 24,    city: "LOS ANGELES",   name: "CHARGERS",   abbr: "LAC", iconURL: "https://ssl.gstatic.com/onebox/media/sports/logos/EAQRZu91bwn1l8brW9HWBQ_48x48.png", active: true}),
    new Team({ id: 15,    city: "MIAMI",         name: "DOLPHINS",   abbr: "MIA", iconURL: "https://ssl.gstatic.com/onebox/media/sports/logos/1ysKnl7VwOQO8g94gbjKdQ_48x48.png", active: true}),
    new Team({ id: 16,    city: "MINNESOTA",     name: "VIKINGS",    abbr: "MIN", iconURL: "https://ssl.gstatic.com/onebox/media/sports/logos/Vmg4u0BSYZ-1Mc-5uyvxHg_48x48.png", active: true}),
    new Team({ id: 17,    city: "NEW ENGLAND",   name: "PATRIOTS",   abbr: "NE",  iconURL: "https://ssl.gstatic.com/onebox/media/sports/logos/z89hPEH9DZbpIYmF72gSaw_48x48.png", active: true}),
    new Team({ id: 18,    city: "NEW ORLEANS",   name: "SAINTS",     abbr: "NO",  iconURL: "https://ssl.gstatic.com/onebox/media/sports/logos/AC5-UEeN3V_fjkdFXtHWfQ_48x48.png", active: true}),
    new Team({ id: 19,    city: "NEW YORK",      name: "GIANTS",     abbr: "NYG", iconURL: "https://ssl.gstatic.com/onebox/media/sports/logos/q8qdTYh-OWR5uO_QZxFENw_48x48.png", active: true}),
    new Team({ id: 20,    city: "NEW YORK",      name: "JETS",       abbr: "NYJ", iconURL: "https://ssl.gstatic.com/onebox/media/sports/logos/T4TxwDGkrCfTrL6Flg9ktQ_48x48.png", active: true}),
